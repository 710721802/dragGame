 ...
 * @LastEditTime: 2022-06-21 18:10:10
 * @FilePath: \dragGame\src\views\selectBackGround\index.vue
	...
	<div class="selectBackGround">
		...
		<div class="contentBox">
			...
			<van-swipe class="my-swipe" indicator-color="white">
				<van-swipe-item>
					<img src="@/assets/gameSection/banner.png" alt="">
				</van-swipe-item>
				<van-swipe-item>
					<img src="@/assets/gameSection/banner02.png" alt="">
				</van-swipe-item>
			</van-swipe>
		</div>
		<div class="confirmBtnBox">
			<span @click="goTo('gameMainPage')">确定</span>
		</div>
	</div>
</template>
